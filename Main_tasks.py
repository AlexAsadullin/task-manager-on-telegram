...
TOKEN = '7175712627:AAEnewR_LaPlruldxttUpbT5GpnvDH1_duA' # токен от @botfather
bot = telebot.TeleBot(TOKEN) # создаем бота

tasks = {} # словарь с задачами: key: имя задачи, value: срок выполнения
MESSG = {} # сохраняем id чата, в который пишем сообщения
